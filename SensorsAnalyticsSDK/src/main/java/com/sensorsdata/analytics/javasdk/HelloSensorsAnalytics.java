...
public class HelloSensorsAnalytics {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        final ISensorsAnalytics sa =
                new SensorsAnalytics(new ConcurrentLoggingConsumer("file.log"));

        // 设置公共属性,以后上传的每一个事件都附带该属性
        SuperPropertiesRecord propertiesRecord =
                SuperPropertiesRecord.builder()
        ...
        SensorsAnalyticsIdentity identity1 =
