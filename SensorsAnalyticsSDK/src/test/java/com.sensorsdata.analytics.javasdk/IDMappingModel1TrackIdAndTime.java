...
public class IDMappingModel1TrackIdAndTime extends SensorsBaseTest {
    ...
    public void testProfileIncrement() {
        ...
        try {
            ...
            Assertions.fail("[ERROR] profileIncrement should throw InvalidArgumentException.");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void testProfileIncrement01() {
        ...
        try {
            ...
            e.printStackTrace();
            Assertions.assertEquals(
                    "The property '$time' should be a java.util.Date.", e.getMessage());
        }
    }
    ...
    public void testProfileUnset() {
        ...
        try {
            ...
            Assertions.assertEquals("The property value of $time should be true.", e.getMessage());
        }
    }
    ...
    public void testProfileIncrementEventBuilder() {
        ...
        try {
            ...
            Assertions.fail("profileIncrement should throw InvalidArgumentException");
        } catch (InvalidArgumentException e) {
            Assertions.assertEquals(
                    "The property value of PROFILE_INCREMENT should be a Number.The current type is class java.util.Date.",
                    e.getMessage());
    ...
    public void testProfileAppendByIdEventBuilder() throws InvalidArgumentException {
        ...
        try {
            ...
            Assertions.fail("profileAppend should throw InvalidArgumentException");
        } catch (InvalidArgumentException e) {
            Assertions.assertEquals(
    ...
    public void testProfileUnsetByIdEventBuilder() {
        ...
        try {
            ...
            Assertions.fail("profileUnset should throw InvalidArgumentException");
        } catch (InvalidArgumentException e) {
            Assertions.assertEquals("The property value of $time should be true.", e.getMessage());
        }
    }
