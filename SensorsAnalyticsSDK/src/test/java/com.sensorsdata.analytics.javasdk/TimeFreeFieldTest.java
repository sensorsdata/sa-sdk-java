...
public class TimeFreeFieldTest extends SensorsBaseTest {
  ...
  public void trackTest() throws InvalidArgumentException {
    ...
    assertTrue(data.containsKey("time_free"));
    assertTrue(Boolean.parseBoolean(data.get("time_free").toString()));
    assertTrue(properties.containsKey("key1"));
    assertFalse(properties.containsKey("$time_free"));
  }
  ...
  public void trackTest1() throws InvalidArgumentException {
    ...
    EventRecord eventRecord =
        EventRecord.builder().setDistinctId("test1").isLoginId(false).setEventName("test").addProperties(pro).build();
  ...
  public void trackTest2() throws InvalidArgumentException {
    ...
    assertEventData(data);
    Map<String, Object> properties = (Map<String, Object>) data.get("properties");
    assertFalse(data.containsKey("time_free"));
    assertFalse(properties.containsKey("$time_free"));
  }
  ...
  public void profileTest1() throws InvalidArgumentException {
    ...
    pro.put("key1", "aaa");
    pro.put("$time_free", true);
    UserRecord userRecord = UserRecord.builder().setDistinctId("test1").isLoginId(true).addProperties(pro).build();
  ...
  public void itemTest1() throws InvalidArgumentException {
    ...
    pro.put("key1", "aaa");
    pro.put("$time_free", true);
    ItemRecord itemRecord = ItemRecord.builder().setItemId("test1").setItemType("aa1").addProperties(pro).build();
  ...
  public void IDMTrackTest() throws InvalidArgumentException {
    IDMEventRecord eventRecord = IDMEventRecord.starter().setEventName("test1").setDistinctId("ee1")
        .addIdentityProperty("test", "e22ee")
        .addProperty("$time_free", true).build();
  ...
  public void IDMProfileTest() throws InvalidArgumentException {
    ...
    pro.put("key1", "aaa");
    pro.put("$time_free", true);
    IDMUserRecord userRecord = IDMUserRecord.starter().addIdentityProperty("test1", "ee").addProperties(pro).build();
  ...
  public void NGUserEventTrackTest() throws InvalidArgumentException {
    ...
    pro.put("key1", "aaa");
    pro.put("$time_free", true);
    UserEventSchema userEventSchema = UserEventSchema.init().addIdentityProperty("key1", "ee1")
        .setEventName("test1")
        .addProperties(pro)
        .start();
  ...
  public void NGItemEventTrackTest() throws InvalidArgumentException {
    ItemEventSchema itemEventSchema = ItemEventSchema.init().setSchema("test1")
  ...
  public void NGUserProfileTest() throws InvalidArgumentException {
    UserSchema userSchema = UserSchema.init().setUserId(22L).addProperty("$time_free", true).start();
  ...
  public void NGItemTest() throws InvalidArgumentException {
    ItemSchema itemSchema =
        ItemSchema.init().setSchema("test33").setItemId("ee2").addProperty("$time_free", true).start();
